...
export const softwareCards = [
  ...
  { title: { "pt-br": "Patch Builder", en: "Patch Builder", de: "Patch Builder" }, text: { "pt-br": "Uma pequena ferramenta para construir patches modulares em browser.", en: "A small tool to build modular patches in the browser.", de: "Ein kleines Tool zum Erstellen modularer Patches im Browser." } },
  { title: { "pt-br": "Visualizer", en: "Visualizer", de: "Visualizer" }, text: { "pt-br": "Experimentos com visualização reativa para performance sonora.", en: "Experiments with reactive visualization for sound performance.", de: "Experimente mit reaktiver Visualisierung für Klangperformances." } },
];
